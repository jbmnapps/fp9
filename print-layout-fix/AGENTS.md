...
- Decimaler skrives med komma, fx `2,89`.
- Undgå em-dash i elevrettet tekst. Brug komma, kolon, semikolon eller punktum.
- Større ændringer sparres med Jonas først. Små, aftalte rettelser må laves direkte.
...
- Korrekthed først. Et forkert formelark er værre end intet.
- Math-checker skal godkende, før et ark regnes som færdigt.
- Sprogfeedback fra Jonas skal omsættes til en konkret regel i relevant reviewer-fil, hvis projektet stadig bruger reviewer-protokollerne.
- Designfeedback fra Jonas skal omsættes til en konkret regel i relevant reviewer-fil, hvis projektet stadig bruger reviewer-protokollerne.
- Matematikfejl fanget efter review skal omsættes til en konkret regel i relevant reviewer-fil, hvis projektet stadig bruger reviewer-protokollerne.
